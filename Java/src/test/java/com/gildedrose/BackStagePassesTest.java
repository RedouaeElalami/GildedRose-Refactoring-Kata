...
public class BackStagePassesTest {
    ...
    public void item_BackStagePasses_increasesInQuality_byOneOutside10Days() {
        ...
        assertEquals(app.items[0], new Item("Backstage passes to a TAFKAL80ETC concert", 19, 3));
    }
    ...
    public void item_BackStagePasses_increasesInQuality_byTwoInside10Days() {
        ...
        assertEquals(app.items[0], new Item("Backstage passes to a TAFKAL80ETC concert", 9, 4));
    }
    ...
    public void item_BackStagePasses_increasesInQuality_byThreeInside5Days() {
        ...
        assertEquals(app.items[0], new Item("Backstage passes to a TAFKAL80ETC concert", 4, 5));
    }
    ...
    public void item_BackStagePasses_increasesInQuality_goesToZeroWhenSellInExpires() {
        ...
        assertEquals(app.items[0], new Item("Backstage passes to a TAFKAL80ETC concert", -1, 0));
    }
}
